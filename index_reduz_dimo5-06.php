...
<div class="container">
	<form method="POST" id="formulario1">
		...
		<div class="slidecontainer">
		  <input type="range" min="1" max="100" value="<?php echo $valor?>" class="slider" id="myRange" onchange="vai()">
      ...
      //chamar o index_reduz_dimPROCESSO
      $.ajax({
        method: "POST",
        url: "index_reduz_dimPROCESSO.php",
        data: { valor: v }
      })
...
<?php
echo "<thead>";
echo "<tr class='table-success'><td colspan='3' align='center'>lista de arquivos de ".$Fotos."</td></tr>";
echo "<tr>";
	echo "<th scope='col' class='bg-success'>Nome</th>";
	echo "<th scope='col' class='bg-success'>Tamanho em Kilo Bytes</th>";
	echo "<th scope='col' class='bg-success'></th>";
echo "</tr>";
echo "</thead>";	
for($i=0;$i<count($fotosConvertidas);$i++){
	echo "<tr class='table-success'>";
		echo "<td>".$fotosConvertidas[$i]."</td>";
    echo "<td><img src='teste/$fotosConvertidas[$i]' width='100px'></td>";
...
<?php
echo "<thead>";
echo "<tr class='table-success'><td colspan='3' align='center'>lista de arquivos de ".$Thumbs."</td></tr>";
echo "<tr>";
	echo "<th scope='col' class='bg-success'>Nome</th>";
	echo "<th scope='col' class='bg-success'>Tamanho em Kilo Bytes</th>";
	echo "<th scope='col' class='bg-success'></th>";
...
for($i=0;$i<count($arquivost);$i++){
    ...
    echo "<td><img src='thumbs/$fotosConvertidas[$i]' width='100px'></td>";
